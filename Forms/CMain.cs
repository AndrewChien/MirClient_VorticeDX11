...
//using DX_RenderForm = SlimDX.Windows.RenderForm;
using static Client.MirGraphics.DX_Vortice;
using DX_RenderForm = Vortice.WinForms.RenderForm;

namespace Client
{
    public partial class CMain : DX_RenderForm
    {
        ...
        private static void RenderEnvironment()
        {
            try
            {
                ...
                //DX_DeviceClearTarget00(Color.CornflowerBlue);//测试屏蔽
                DX_DeviceBeginScene();
                DX_SpriteBeginAlphaBlend();
                DXManager.SetSurface(MainSurface);
            ...
            catch (DX_Direct3D9Exception ex)
            {
        ...
        public void CreateScreenShot()
        {
            ...
            using (var stream = DX_DeviceGetBackBuffer00Stream())
            {
        ...
        public static void SetResolution(int width, int height)
        {
            ...
            DX_DeviceClearTarget00(Color.Black);
            DX_DevicePresent();
            DXManager.ResetDevice();
