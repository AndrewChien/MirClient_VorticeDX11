...
namespace Client.MirControls
{
    public class MirControl : IDisposable
    {
        ...
        protected DX_Vector2[] _borderInfo;
        protected virtual DX_Vector2[] BorderInfo
        {
            get
            {
                if (Size == Size.Empty)
                ...
                if (BorderRectangle != DisplayRectangle)
                {
                    _borderInfo = new[]
                        {
                            new DX_Vector2(DisplayRectangle.Left - 1, DisplayRectangle.Top - 1),
                            new DX_Vector2(DisplayRectangle.Right, DisplayRectangle.Top - 1),
                            new DX_Vector2(DisplayRectangle.Left - 1, DisplayRectangle.Top - 1),
                            new DX_Vector2(DisplayRectangle.Left - 1, DisplayRectangle.Bottom),
                            new DX_Vector2(DisplayRectangle.Left - 1, DisplayRectangle.Bottom),
                            new DX_Vector2(DisplayRectangle.Right, DisplayRectangle.Bottom),
                            new DX_Vector2(DisplayRectangle.Right, DisplayRectangle.Top - 1),
                            new DX_Vector2(DisplayRectangle.Right, DisplayRectangle.Bottom)
                        };
        ...
        protected DX_Texture ControlTexture;
        ...
        protected virtual void CreateTexture()
        {
            ...
            if (ControlTexture == null)
            {
                ...
                ControlTexture = DX_NewTextureRenderTargetDefault(Size.Width, Size.Height);
                TextureSize = Size;
            }

            var oldSurface = CurrentSurface;
            var surface = DX_GetSurfaceLevel0(ControlTexture);
            DXManager.SetSurface(surface);
            DX_DeviceClearTarget00(BackColour);
...
// ReSharper restore InconsistentNaming
        ...
        protected internal virtual void DrawControl()
        {
            ...
            DXManager.DrawOpaque(ControlTexture, new Rectangle(0, 0, Size.Width, Size.Height), 
                new System.Numerics.Vector3?(new System.Numerics.Vector3((float)(DisplayLocation.X), (float)(DisplayLocation.Y), 0.0f)), Color.White, Opacity);
        ...
        protected virtual void DrawBorder()
        {
            if (!Border || BorderInfo == null)
                return;
            DX_Flush();
            DX_LineDraw(BorderInfo, _borderColour);
        }
