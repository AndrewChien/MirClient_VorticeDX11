...
namespace Client
{
    class Settings
    {
        ...
        private static InIReader Reader = new InIReader(@".\Mir1Config.ini");
        ...
        public static bool UseTestConfig
        {
            ...
            set 
            {
                if (value == true)
                {
                    Reader = new InIReader(@".\Mir1Test.ini");
                }
        ...
        //AutoPatcher Host removed for now
        public static bool P_Patcher = false;
        public static string P_Host = @"127.0.0.1";
        ...
        public static void Load()
        {
            ...
            //Temp check to update everyones address (Removed host for now)
            //http: //mirfiles.co.uk/mir1/cmir/patch/
            if (P_Host.ToLower() == "/")
            {
                P_Host = "/";
            }
