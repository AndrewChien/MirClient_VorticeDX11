...
namespace Client.MirGraphics
{
    ...
    public sealed class MLibrary
    {
        ...
        public void Draw(int index, Point point, Size size, Color colour)
        {
            ...
            var matrix = DX_MatrixScaling(scaleX, scaleY);
            DX_SpriteTransform = matrix;
            ...
            DX_SpriteTransform = DX_MatrixIdentity();
    ...
    public sealed class MImage
    {
        ...
        public DX_Texture Image;
        //layer 2:
        public short MaskWidth, MaskHeight, MaskX, MaskY;
        public int MaskLength;

        public DX_Texture MaskImage;
        ...
        public unsafe void CreateTexture(BinaryReader reader)
        {
            ...
            //Image = DX_NewTextureNoneManaged(w, h);
            //var stream = DX_TextureLockRectangle(Image);
            //Data = (byte*)DX_DataRectanglePointer(stream);
            //DecompressImage(reader.ReadBytes(Length), stream.Data);
            //stream.Data.Dispose();
            //DX_TextureUnlockRectangle(Image);

            var decompressedData = DecompressDataNew(reader.ReadBytes(Length));
            nint datapoint = 0;
            Image = CreateTextureFromBytes(decompressedData, (uint)Width, (uint)Height, ref datapoint);
